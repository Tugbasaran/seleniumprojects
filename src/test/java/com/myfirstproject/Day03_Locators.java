...
//        isDisplayed returns True if the element is on the page.
//        returns false if the element is not on the page.
        Assert.assertTrue(driver.findElement(By.className("oxd-userdropdown-name")).isDisplayed());

        Thread.sleep(5000);  // waiting for 5 seconds at this point.
  ...
  // Then verify the logout is successful
      ...
      //  Assert.assertTrue(driver.findElement(By.className("oxd-text oxd-text--h5 orangehrm-login-title")).isDisplayed());
       ...
       // I CAN LOCATE ELEMENTS WITH XPATH......
        Assert.assertTrue(
