...
//        Fill the username, password and textArea comment:  First clear the textarea.Then I will send my comment.
...
//        Choose a file and upload it.                Desktop jpeg file----> /Users/Tugba/Desktop/image.jpeg
        driver.findElement(By.name("filename")).sendKeys(System.getProperty("user.home") + "/Desktop/image.jpeg");

//        Select checkbox, radio item and dropdowns.  unselect them first then I will select first checkbox,radio button and dropdown.
        driver
