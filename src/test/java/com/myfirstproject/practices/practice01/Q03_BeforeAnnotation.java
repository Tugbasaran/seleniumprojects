...
public class Q03_BeforeAnnotation {
    ...
    public void test01(){
        ...
        // Verify the result
        assertEquals(String.valueOf(Integer.parseInt(input1)+Integer.parseInt(input2)),result);

        // OR WE CAN USE THESE TWO OF THEM TOO.
        // assertEquals(Integer.parseInt(input1)+Integer.parseInt(input2)+"", result);
        //assertEquals(Integer.parseInt(input1)+Integer.parseInt(input2)+,Integer.parseInt(result));
